...
import { Shield, BookOpen, Play, FileText, CheckCircle2, RotateCcw, ShieldAlert, MessageCircle, Target, Lightbulb } from 'lucide-react';

interface NavbarProps {
  activeTab: 'decks' | 'study' | 'review' | 'quiz' | 'cheatsheet' | 'qa' | 'reddit' | 'objectives' | 'tips';
  setActiveTab: (tab: 'decks' | 'study' | 'review' | 'quiz' | 'cheatsheet' | 'qa' | 'reddit' | 'objectives' | 'tips') => void;
